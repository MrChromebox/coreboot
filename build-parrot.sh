...
if [ "$1" != "legacy" ]; then
	...
	cbfstool ${filename2} add -f ./duet-snb-book-ssd.img -n floppyimg/tianocore.img.lzma -t raw -c lzma
	...
	cbfstool ${filename4} add -f ./duet-ivb-book-ssd.img -n floppyimg/tianocore.img.lzma -t raw -c lzma
