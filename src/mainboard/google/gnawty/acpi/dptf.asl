...
Name (DTRT, Package () {
	...
	Package () { \_SB.DPTF.TCPU, \_SB.DPTF.TSR0, 100, 300, 0, 0, 0, 0 },

#ifdef DPTF_ENABLE_CHARGER
	/* Charger Effect on Temp Sensor 1 */
	Package () { \_SB.DPTF.TCHG, \_SB.DPTF.TSR1, 200, 1200, 0, 0, 0, 0 },
#endif

	/* CPU Effect on Temp Sensor 2 */
	Package () { \_SB.DPTF.TCPU, \_SB.DPTF.TSR2, 100, 60, 0, 0, 0, 0 },
})
